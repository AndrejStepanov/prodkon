export default {
	...
	texts:{
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        astroRes:{
			noInitDataTitle:'Не указаны дата и место рождения!',
			noInitDataText:'Перейдите в личный кабинет, что бы указать данные, необходимые для определения склонности к той или иной профессии в зависимости от констелляций',
			ruleOnProf:'Влияет на профессии:',
